  ...
  return (
    <form className="custom-form" onSubmit={submit}>
      ...
      <div className="custom-form">
        <input className="custom-input" placeholder="First Name" {...register("firstName")} />
        {errors?.user?.firstName?.message && <p className="format-message error">First Name: {errors.user.firstName.message}</p>}
        <input className="custom-input" placeholder="Last Name" {...register("lastName")} />
        {errors?.user?.lastName?.message && <p className="format-message error">Last Name: {errors.user.lastName.message}</p>}
